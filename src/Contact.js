...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const isFormValid = ({ firstName, lastName, phone, email, address, message }) => {
        ...
        if (isFormValid(userData)) {
            const res = fetch("https://labproject-8fb25-default-rtdb.asia-southeast1.firebasedatabase.app/userData.json", {
                method: "POST",
                headers: {
                            ...
                            <div className="row">
                                ...
                                <div className="contact-rightside col-12 col-lg-7">
                                    <form method="POST">
                                        ...
                                        <button
                                            type="submit"
                                            className="btn btn-style w-100" onClick={handleSubmit}>
                                            Submit
                                        </button>
                                    </form>
                                </div>
